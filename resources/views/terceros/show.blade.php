...
@section('content')
    ...
    <ul>
        @foreach ($tercero->contactos as $contacto)
            <li>{{ $contacto->nombre }} - {{ $contacto->telefono }}<a href="https://wa.me/{{ $contacto->telefono }}" target="blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
