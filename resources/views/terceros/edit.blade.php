                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div>
                                        <h3>Rut</h3>
                                        @if ($tercero->rut)
                                            <embed src="{{ asset('storage/rut/' . $tercero->rut) }}" width="100%"
                                                height="600">
                                            <a href="{{ asset('storage/rut/' . $tercero->rut) }}" target="_blank"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <ul>
                                            @if ($tercero->certificacion_bancaria)
                                                <li><a href="{{ route('terceros.downloadCertificacion', ['id' => $tercero->id]) }}">Descargar</a></li>
                                            @endif
                                        </ul>
                                    </div>
