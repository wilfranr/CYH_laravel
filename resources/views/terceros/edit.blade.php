                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <select name="tipo" id="tipo" class="form-control select2">
                                        ...
                                        <option value="cliente" {{ $tercero->tipo == 'cliente' ? 'selected' : '' }}>
                                            Cliente</option>
                                        <option value="proveedor" {{ $tercero->tipo == 'proveedor' ? 'selected' : '' }}>
                                            Proveedor</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div>
                                        ...
                                        @if ($tercero->rut)
                                            ...
                                            <a href="{{ asset('storage/' . $tercero->rut) }}" target="_blank"
                                                class="btn btn-outline-primary">Ver en una pestaña nueva</a>
                                        @else
                                    ...
                                    <div class="form-group border border-warning mt-4 p-3">
                                        ...
                                        @endif
                                        <a href="{{ route('maquinas.create') }}" class="btn btn-primary mt-2">Agregar
                                            nueva máquina</a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <ul>
                                            @if ($tercero->certificacion_bancaria)
                                                <li><a href="{{ route('terceros.downloadCertificacion', ['id' => $tercero->id]) }}">Descargar</a>
                                                </li>
                                            @endif
                                        </ul>
                                    </div>
