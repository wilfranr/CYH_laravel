            ...
            <tbody>
                @foreach ($terceros as $tercero)
                    <tr>
                        ...
                        <td>
                            {{ $tercero->telefono }}
                            <a href="https://wa.me/{{ $tercero->telefono }}" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
